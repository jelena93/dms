...
public class AppConfig extends WebMvcConfigurerAdapter {
    ...
    public boolean insertValuesInDB() {
        return Boolean.valueOf(ResourceBundle.getBundle("aplication").getString("insert_values_in_db"));
    }

    @Bean
    public boolean dropAndCreateDB() {
        return Boolean.valueOf(ResourceBundle.getBundle("aplication").getString("drop_and_create_db"));
    }

    @Bean
    public boolean createAndAddInIndex() {
        return Boolean.valueOf(ResourceBundle.getBundle("aplication").getString("create_and_add_in_index"));
    }
